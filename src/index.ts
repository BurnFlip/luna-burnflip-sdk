...
export const bet = (data: BetDto): Promise<AxiosResponse> => {
  return axios.post(API_URL, data);
}

export const getWLUNAClient = (client: LCDClient, wallet: Wallet | ConnectedWallet): WluncClient => {
  return new WluncClient(client, wallet);
}

export const getFlipClient = (client: LCDClient, wallet: Wallet | ConnectedWallet): FlipClient => {
